...
public class AulaController {
    ...
    @DeleteMapping(value = "/api/admin/aula/{aulaId}/conteudo/{conteudoId}",
            ...
            produces = MediaType.APPLICATION_JSON_VALUE)
    public ResponseEntity<String> deletarConteudo(@PathVariable
                                                  UUID aulaId, @PathVariable UUID conteudoId) throws Exception {
    ...
    @DeleteMapping(value = "/api/admin/aula/{aulaId}",
            consumes = MediaType.APPLICATION_JSON_VALUE,
            produces = MediaType.APPLICATION_JSON_VALUE)
    public ResponseEntity<String> deletarAula(@PathVariable UUID aulaId) throws Exception {
